...
Finally, a demographic questionnaire collected information on age, ethnicity, political affiliation, and familiarity with homelessness.

## Analysis
The study used a 2 x 3 between-subjects design with race (Black/White) and mental illness diagnosis (schizophrenia, substance use disorder, no mental illness) as independent variables, and stigmatization as the dependent variable. Stigmatization was measured through factors like blame, perceived dangerousness, social distance, willingness to help, and emotional response.
