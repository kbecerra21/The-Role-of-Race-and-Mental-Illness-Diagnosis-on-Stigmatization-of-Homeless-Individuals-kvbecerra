...
```{r}
write.csv(SPSS_File_for_Experimental_Study_Karen, "Experimental_Study_Karen.csv", row.names = FALSE) # changed the original data file from SPSS to CSV file to clean the data. I only had acess to the data via SPSS as this was the only programing that I did through my undergraduate experince. 
