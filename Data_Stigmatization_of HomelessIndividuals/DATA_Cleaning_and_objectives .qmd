...
I could not get the tbl- format in my final paper it would not render correctly so i used the other foramt given in the  apa quartp extension for my tables the plots did work. 
# more work with data
