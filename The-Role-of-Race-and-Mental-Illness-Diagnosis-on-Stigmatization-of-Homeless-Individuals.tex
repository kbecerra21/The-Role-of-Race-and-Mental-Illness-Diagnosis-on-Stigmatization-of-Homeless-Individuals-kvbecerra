...
= 0.07, p = 0.85. \textbf{Figure 1} shows the F-values for the main
...
\textbf{Figure 2} shows the effect of mental illness diagnosis on social
distance stigma. The mean stigma scores for each diagnosis are as
follows:No Diagnosis: 2.58 (SD = 1.12), Schizophrenia: 3.4 (SD =
1.21),Substance Use Disorder: 3.24 (SD = 1.26)
