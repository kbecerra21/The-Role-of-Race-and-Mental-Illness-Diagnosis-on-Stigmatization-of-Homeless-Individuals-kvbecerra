...
{\caption{{Correlation between age of participants and mean help
offering}{\label{fig-correlation-age-and-mean-help}}}}

\pandocbounded{\includegraphics[keepaspectratio]{The-Role-of-Race-and-Mental-Illness-Diagnosis-on-Stigmatization-of-Homeless-Individuals_files/figure-pdf/fig-correlation-age-and-mean-help-1.pdf}}

{\noindent \emph{Note.} The plot shows the relationship between age of
participants and mean help offering, with a regression line in blue
indicating the trend.The red line is the mean. The correlation
coefficient quantifies the strength and direction of this relationship.}

\end{figure}

Finally, we conducted a correlation analysis to examine the relationship
between participants' age and their mean help offering. The Pearson
correlation coefficient between age and mean help offering was -0.18,
quantifying the strength and direction of this relationship in this case
a negative relationship.

The results indicated a significant correlation, r = -0.18, \emph{p} =
0.00851, suggesting that age is meaningfully associated with help
offering. \textbf{Figure~\ref{fig-correlation-age-and-mean-help}} shows
the relationship between participants' age and their mean help offering,
with a regression line indicating the trend. The red line represents the
mean help offering, while the blue line shows the direction of the
correlation.
