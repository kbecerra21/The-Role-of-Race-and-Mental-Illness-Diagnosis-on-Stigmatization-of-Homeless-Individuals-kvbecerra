...
\subsubsection{Figure 1 Main effect of mental illness diagnosis on
desired social distance
stigma.}\label{figure-1-main-effect-of-mental-illness-diagnosis-on-desired-social-distance-stigma.}

\begin{figure}[!htbp]

{\caption{{Main effect of mental illness diagnosis on desired social
distance stigma.}{\label{fig-social-distance-stigma}}}}
...
{\noindent \emph{Note.} The plot illustrates the significant difference
in social distance stigma scores between homeless individuals with no
