...
\subsection{Main effects of race and diagnosis on social
interaction}\label{main-effects-of-race-and-diagnosis-on-social-interaction}

Figure 1 shows the effect of mental illness diagnosis on social distance
stigma. The mean stigma scores for each diagnosis are as follows: -
\textbf{No Diagnosis}: 2.58 (SD = 1.12) - \textbf{Schizophrenia}: 3.4
(SD = 1.21) - \textbf{Substance Use Disorder}: 3.24 (SD = 1.26)
